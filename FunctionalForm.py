...
# Generate mesh
mesh = generate_mesh(geometry, 85)
...
print('Double Unwrapped Phase Plot')

plt.figure()
plt.tricontourf(tri, unwrap2, 100)
plt.plot(xLine, yLine)
plt.colorbar()
plt.show()

plt.figure()
plt.tricontourf(tri, unwrap2_0, 100)
plt.plot(xLine, yLine)
plt.colorbar()
plt.show()

print('Diff Unwrapped Phase Plot')

plt.figure()
plt.tricontourf(tri, unwrap2 - unwrap2_0, 100)
plt.plot(xLine, yLine)
plt.colorbar()
plt.show()

print('Line Phase Plot')

plt.plot(xLine/np.cos(theta), Uphase)
plt.plot(xLine/np.cos(theta), Uphase_0)
plt.show()

print('Diff Line Plot')

plt.plot(xLine/np.cos(theta), Uphase - Uphase_0)
plt.show()